...
import com.alibaba.adam.parser.SourceDbType;
import com.alibaba.excel.EasyExcel;
import com.alibaba.excel.ExcelWriter;
import com.alibaba.excel.write.metadata.WriteSheet;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.aliyun.adam.sqlconverter.ConvertDescriptionHolder;
import com.aliyun.adam.sqlconverter.SqlTranslator;
import com.aliyun.adam.sqlconverter.common.TranslateConfig;
import com.aliyun.adam.sqlconverter.common.db.DatabaseType;
import com.aliyun.adam.sqlconverter.common.db.polaro.PolaroVersion;
import com.aliyun.adam.sqlconverter.common.report.ChangedReportInfo;
import com.aliyun.adam.sqlconverter.common.report.TranslateReport;
import com.aliyun.adam.sqlconverter.common.report.UnsupportedReportInfo;
import com.aliyun.adam.sqlconverter.common.report.description.ConvertDescriptionInfo;
import com.aliyun.adam.sqlconverter.common.report.description.DescriptionLanguage;
...
public class Frodo {
    ...
    private static final TranslateConfig config = TranslateConfig.builder().databaseType(DatabaseType.POLARO).databaseVersion(PolaroVersion.V_20210309).sourceDbType(SourceDbType.ORACLE).build();
...
//            System.out.println("--exclude-network-round if set, will substract network round time for return time statistics");
    ...
    private static void initArgs(String[] args) throws Exception {
        ...
        options.addOption(null, "source-db", true, "mysql|oracle|db2");
...
//        options.addOption(null,"exclude-network-round", false, "if set, will substract network round time for return time statistics;");
        ...
        if (commandLine.hasOption("--license-path")) {
            Config.licensePath = commandLine.getOptionValue("license-path");
        } else {
            logger.error("no license,you can set --license-path=xxx.key");
            System.exit(1);
        }
